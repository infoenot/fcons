...
const Header: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-fin-bg sticky top-0 z-50 pb-4 px-6 transition-all duration-300 shadow-sm w-full" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 90px)' }}>
