                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col gap-3">
                                    ...
                                    <div className="flex justify-between items-end">
                                        ...
                                        {t.status === 'PLANNED' ? <span className="text-[10px] font-medium px-1.5 py-0.5 rounded border border-fin-border text-fin-textTert">План</span> : <span className="text-[10px] font-medium px-1.5 py-0.5 rounded border border-fin-border text-fin-textTert">Факт</span>}
                                    </div>
                                </div>
                            </div>
                            );
